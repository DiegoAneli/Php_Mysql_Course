...
foreach( $csv as $r ){
    ...
    if ($count == 0) {
        ...
        $stmt = $conn->prepare("INSERT INTO dati (mese, valore, anno) VALUES (?, ?, ?)");
...
$conn->close();
echo "<h3> Inseriti solo i mesi nuovi per l anno $anno </h3><a href='index.php'>Torna alla home page</a>";
